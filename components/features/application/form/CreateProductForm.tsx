...
import { ProductType, PRODUCT_TYPE_LABELS } from "@/lib/domain/product/types";
import { createProductSchema, type CreateProductInput } from "@/lib/domain/product/schemas";
import { createCustomProduct } from "@/lib/domain/product/actions";
  ...
  const onSubmit = async (data: CreateProductInput) => {
    try {
      ...
      if (result.success) {
        ...
        onProductCreated(result.data.id, data.name, data.type);
      } else {
